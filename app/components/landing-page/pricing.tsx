  ...
  return(
    <div className="my-[150px] flex flex-col items-center gap-14">
      <div className="flex flex-col items-center gap-6">
        ...
        <p className="text-content-body text-xl text-center">Junte-se a comunidade de criadores profissionais que ja estao elevando sua <br />
          presenca online. Teste gratuitamente por <strong className="text-accent-pink">{TRIAL_DAYS} dias</strong>, sem compromisso!
        </p>
      </div>
      <div className="flex items-end gap-9">
        ...
        <div className="flex flex-col">
          <div className="flex justify-center items-center rouded-t-2xl p-2 w-[304px] bg-[linear-gradient(90deg,#4B2DBB_0%,#B5446B_100%)]">
